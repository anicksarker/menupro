#!/usr/bin/env python3
# =============================================================================
#  build_wl_model_34.py   (Plan 34 - Whole Life, Limited PPT)
# -----------------------------------------------------------------------------
...
MODEL_SPEC = {
  ...
  'Inputs': {
    ...
    "fills": [
      ...
      ['B', 27, 27, 'trans', '=MIN(B8,B16)', []],
      ['B', 28, 28, 'trans', '=EDATE(B11,B8*12)>B12', []],
    ],
    "colfmt": {},
    "fmt_exc": {
        'B11': 'mm-dd-yy',
  ...
  'MORTALITY': {
    ...
    "fills": [
      ...
      ['D', 2, 101, 'trans', '=IFERROR(IF(A2="","",C2*(1-B3)),0)', []],
      ['D', 102, 123, 'trans', '=IFERROR(IF(A102="","",C102*(1-B103)),"")', []],
    ],
    "colfmt": {
        'B': '0.00000_)',
        'C': '0.00000_)',
    ...
    "widths": {'B': 18.82, 'C': 10.63, 'D': 13.82},
  },
  'Commutation': {
    "statics": {
        'A1': 'Age',
    ...
    "fills": [
      ...
      ['E', 2, 110, 'trans', '=IF(A2="","",IFERROR((1/(1+Inputs!$B$21))^A2,0))', []],
      ['F', 2, 110, 'trans', '=IF(A2="","",IFERROR(C2*E2,0))', []],
      ['G', 2, 110, 'trans', '=IF(A2="","",IFERROR(D2*(1/(1+Inputs!$B$21))^(A2+1),0))', []],
  ...
  'RPU': {
    ...
    "fills": [
      ...
      ['B', 8, 8, 'trans', '=IF(Inputs!$B$28=FALSE,"",INDEX(CV_RATES!$J:$J,MATCH(Inputs!$B$16,CV_RATES!$C:$C,0))/1000*Inputs!$B$18)', []],
  ...
  'ETI': {
    ...
    "fills": [
      ...
      ['E', 3, 3, 'lit', '=IF(Inputs!$B$28=FALSE,"",IFERROR(MATCH(TRUE,E9:E51<0,0)-1,SUMPRODUCT((E9:E51<>"")*1)))', []],
      ['E', 4, 4, 'lit', '=IF(Inputs!$B$28=FALSE,"",IFERROR(IF(E3="","",IF(INDEX(E9:E51,E3+1)<0,INDEX(E9:E51,E3)/(INDEX(E9:E51,E3)-INDEX(E9:E51,E3+1)),0)),""))', []],
